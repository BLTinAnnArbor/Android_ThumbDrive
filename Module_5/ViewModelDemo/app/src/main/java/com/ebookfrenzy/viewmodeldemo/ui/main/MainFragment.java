        ...
        convertButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v){
                ...
                if(!dollarText.getText().toString().equals("")){
                    mViewModel.setAmount(dollarText.getText().toString()); // what if I
                    resultText.setText(mViewModel.getResult().toString()); // switched these?
                    //mViewModel.setAmount(dollarText.getText().toString()); // Then it lags behind by one
                }else {
